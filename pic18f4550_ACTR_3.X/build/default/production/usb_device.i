...
# 10 "/opt/microchip/xc8/v2.41/pic/include/c99/limits.h" 3
...
# 1 "./usb_device_local.h" 1
# 35 "./usb_device_local.h"
typedef union
{
    struct
    {
...
volatile uint8_t CtrlTrfData[32] __attribute__((address(((0x400 +(((2 + 1) * 4)*4)) + 32))));
# 215 "usb_device.c"
...
void USBDeviceAttach(void)
{
    ...
    if(USBDeviceState == DETACHED_STATE)
    {
        if(1 == 1)
        {
            ...
            {IPR2bits.USBIP = 1;PIE2bits.USBIE = 1;};
...
static void USBCtrlTrfTxService(void)
{
    ...
    byteToSend = 32;
    if(inPipes[0].wCount.Val < (uint8_t)32)
    {
