...
//------------------------------------------------------------------------------
    ...
    #if defined(USB_INTERRUPT)
        #define USBEnableInterrupts() {IPR3bits.USBIP = 1;PIE3bits.USBIE = 1;}
    #else
...
//------------------------------------------------------------------------------
    ...
    //STALLIE, IDLEIE, TRNIE, and URSTIE are all enabled by default and are required
    #if defined(USB_INTERRUPT)
        #define USBEnableInterrupts() {PIE2bits.USBIE = 1;}
    #else
        #define USBEnableInterrupts()
    #endif
...
//------------------------------------------------------------------------------
    ...
    //STALLIE, IDLEIE, TRNIE, and URSTIE are all enabled by default and are required
    #if defined(USB_INTERRUPT)
            #define USBEnableInterrupts() {IPR2bits.USBIP = 1;PIE2bits.USBIE = 1;}
    #else
        #define USBEnableInterrupts()
    #endif
